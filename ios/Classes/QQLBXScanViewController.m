...
-(void) cancel{
    ...
    [self.scanDelegate didScanBarcodeWithResult:nil];
...
- (void)drawBottomItems
{
    ...
    [_btnPhoto setImage:[UIImage imageNamed:@"KeScan.bundle/qr_scan_btn_enter"] forState:UIControlStateNormal];
    [_btnPhoto addTarget:self action:@selector(manualEnter) forControlEvents:UIControlEventTouchUpInside];
...
- (void)scanResultWithArray:(NSArray<LBXScanResult*>*)array
{
    ...
    //把结果返回
    [self.scanDelegate didScanBarcodeWithResult:strResult];
...
//手动输入
- (void) manualEnter{
    [self.scanDelegate didScanBarcodeWithResult:@"manual_enter"];
    [self dismissViewControllerAnimated:NO completion:nil];
}
...
- (void)myQRCode
{
    ...
    [self.scanDelegate didScanBarcodeWithResult:@"my_qr_code"];
    [self dismissViewControllerAnimated:NO completion:nil];
}
